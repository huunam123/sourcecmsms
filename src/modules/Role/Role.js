			...
			<>	
				...
				*/}
				<RoleLayout
					...
					fields={[
						{key:'permissions',label:'Module',type:'text',col:'left',isRequied:true,tabKey: "info"},
						{key:'name',label:'Tên module',type:'text',col:'left',isRequied:true,tabKey: "info"},
						{key:'addMore',type:'addMore',col:'left',targetField:'fields',tabKey:'system'},
					]}
				/>
			</>
		)
